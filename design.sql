...
ALTER TABLE `people`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `secretCode` (`secretCode`);
...
--
ALTER TABLE `intelreports`
  ADD CONSTRAINT `intelreports_ibfk_1` FOREIGN KEY (`reporterId`) REFERENCES `people` (`id`),
  ADD CONSTRAINT `intelreports_ibfk_2` FOREIGN KEY (`targetId`) REFERENCES `people` (`id`);
COMMIT;
